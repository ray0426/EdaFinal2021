...
vector<int> _find_id_in_vector(vector<Pin> p, int r, int c)
{
    ...
    for(auto v : p) 
    {
        if(v.locate.row == r && v.locate.col == c) ret.push_back(v.lay);
    }
    return ret;
}
...
{
    if(a.s_col == b.s_col && a.e_col == b.e_col && a.s_layer == b.s_layer && a.e_layer == b.e_layer)
    {
        return (a.s_row <= b.s_row && a.s_row <= b.e_row && a.e_row >= b.s_row && a.e_row >= b.e_row)||
        (a.e_row <= b.s_row && a.e_row <= b.e_row && a.s_row >= b.s_row && a.s_row >= b.e_row);
    }
    if(a.s_row == b.s_row && a.e_row == b.e_row && a.s_layer == b.s_layer && a.e_layer == b.e_layer)
    {
        return (a.s_col <= b.s_col && a.s_col <= b.e_col && a.e_col >= b.s_col && a.e_col >= b.e_col)||
        (a.e_col <= b.s_col && a.e_col <= b.e_col && a.s_col >= b.s_col && a.s_col >= b.e_col);
    }
    if(a.s_row == b.s_row && a.e_row == b.e_row && a.s_col == b.s_col && a.e_col == b.e_col)
    {
        return (a.s_layer <= b.s_layer && a.s_layer <= b.e_layer && a.e_layer >= b.s_layer && a.e_layer >= b.e_layer)||
        (a.e_layer <= b.s_layer && a.e_layer <= b.e_layer && a.s_layer >= b.s_layer && a.s_layer >= b.e_layer);
    }
    if(a.s_col == b.e_col && a.e_col == b.s_col && a.s_layer == b.e_layer && a.e_layer == b.s_layer)
    {
        return (a.s_row <= b.s_row && a.s_row <= b.e_row && a.e_row >= b.s_row && a.e_row >= b.e_row)||
        (a.e_row <= b.s_row && a.e_row <= b.e_row && a.s_row >= b.s_row && a.s_row >= b.e_row);
    }
    if(a.s_row == b.e_row && a.e_row == b.s_row && a.s_layer == b.e_layer && a.e_layer == b.s_layer)
    {
        return (a.s_col <= b.s_col && a.s_col <= b.e_col && a.e_col >= b.s_col && a.e_col >= b.e_col)||
        (a.e_col <= b.s_col && a.e_col <= b.e_col && a.s_col >= b.s_col && a.s_col >= b.e_col);
    }
    if(a.s_row == b.e_row && a.e_row == b.s_row && a.s_col == b.e_col && a.e_col == b.s_col)
    {
        return (a.s_layer <= b.s_layer && a.s_layer <= b.e_layer && a.e_layer >= b.s_layer && a.e_layer >= b.e_layer)||
        (a.e_layer <= b.s_layer && a.e_layer <= b.e_layer && a.s_layer >= b.s_layer && a.s_layer >= b.e_layer);
    }
...
void _wire_compress(vector<la_Wire> &w)
{
    for(int i = 0; i < w.size()-1; i++)
    {
        ...
        {
            if(_is_overlap(w.at(i), w.at(j))) w.erase(w.begin()+j); 
            else if(_is_overlap(w.at(j), w.at(i))) w.erase(w.begin()+i);
        }
    }
}
...
void _layer_assignment_and_print_route(Problem *p, vector<Net2D> &net)
{
    ...
    for(auto a : net2d)
    {
        ...
        if(root->is_pin && root->pin_layer.size() == 1 && root->layer != root->pin_layer.at(0))
        {
            la_Wire w;
        ...
        for(auto a : dft)
        {
            ...
            if(a->is_pin && a->pin_layer.size() == 1 && a->layer != a->pin_layer.at(0))
            {
                la_Wire w;
